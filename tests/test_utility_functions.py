import pytest
from main.utility_functions import get_exchange_data, recalculate_casino_bot_sell_price, create_casino_bot_buy_order_net
...
def test_create_casino_bot_buy_order_net():
    assert create_casino_bot_buy_order_net(deposit=10,
                                           entry_commitment=1,
                                           buy_order_factor=2,
                                           initial_price=1,
    ...
    assert create_casino_bot_buy_order_net(deposit=1000,
                                           entry_commitment=0.1,
                                           buy_order_factor=3,
                                           initial_price=0.1,
